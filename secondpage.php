...
<body>
            ...
            <div class="tables">
                <table class="tableFilmek">
                    ...
                    <tr>
                        ...
                        <th class=secondcolumn id="originalTitleValue"><?php echo $data['movies'][$valtozo]['originalTitle']; ?></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th class=secondcolumn id="starsValue"><?php foreach ($data['movies'][$valtozo]['actors'] as $index => $actor) {
                    ...
                    <tr>
                        ...
                        <th class=secondcolumn id="directorValue"><?php foreach ($data['movies'][$valtozo]['directors'] as $index => $directors) {
    ...
    <input type="hidden" name="valtozo" value="<?php echo $valtozo; ?>">
